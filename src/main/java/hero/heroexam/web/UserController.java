...
import hero.heroexam.domain.binding.UserLoginBindingModel;
import hero.heroexam.domain.binding.UserRegisterBindingModel;
    ...
    public String loginConfirm(@Valid @ModelAttribute("userLoginBindingModel") UserLoginBindingModel userLoginBindingModel,
        ...
        if (bindingResult.hasErrors()) {
            ...
            if (user == null || !user.getPassword().equals(userLoginBindingModel.getPassword())) {
                redirectAttributes.addFlashAttribute("userLoginAddBindingModel", userLoginBindingModel);
